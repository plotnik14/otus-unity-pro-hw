...
public partial class GameEntity {
    ...
    public Core.Components.PositionComponent position { get { return (Core.Components.PositionComponent)GetComponent(GameComponentsLookup.Position); } }
    ...
    public void AddPosition(UnityEngine.Vector3 newValue) {
        ...
        var component = (Core.Components.PositionComponent)CreateComponent(index, typeof(Core.Components.PositionComponent));
